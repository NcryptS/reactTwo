...
wrap with provider in App.jsx set the values in the provider
define functionality of the variables and function of context in App.jsx
define function to remove any mode in html and add the themeMode variable in html class
...
# remember to change config in tailwind (older version)
...
# index.js add for changing tailwind config (newer version)
