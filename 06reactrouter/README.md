...
create Footer.jsx
create Home.jsx
set up Layout.jsx file in src for route handling -> header, footer static and pages dynamic
...
```CSS
className="flex align-center justify-center bg-gray-700 text-white text-3xl p-4"
```
    ...
    <div className="mx-auto w-full max-w-7xl">
      ...
      <div className="grid  place-items-center sm:mt-20">
        <img
          ...
          src="https://globalvoices.org/wp-content/uploads/2021/05/Remote1-1-800x450.png"
          alt="image2"
        />
      </div>
